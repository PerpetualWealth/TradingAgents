...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock", on_chunk=None, callbacks=None):
        ...
        try:
            return self._run_graph(company_name, trade_date, asset_type=asset_type, on_chunk=on_chunk, callbacks=callbacks)
        finally:
    ...
    def _run_graph(self, company_name, trade_date, asset_type: str = "stock", on_chunk=None, callbacks=None):
