#!/usr/bin/env python3
"""
TradingAgents Lite - 轻量版入口
从 .env 加载配置，使用原生 TradingAgentsGraph
辩论轮数: 1
数据源: 全部 yfinance（lite 模式）
"""
...
def run_analysis(ticker: str, trade_date: str = None):
    ...
    # 数据源配置 - lite 模式全部使用 yfinance
    config["data_vendors"] = {
        "core_stock_apis": "yfinance",
        "technical_indicators": "yfinance",
        "fundamental_data": "yfinance",      # yfinance 有基本面数据
        "news_data": "yfinance",             # yfinance 有 news
    }
